...
\begin{figure}[h]
 ...
 \caption{Pneumonia and Influenza mortality from 1910-1922 in London: note the three peaks due to the spanish flu. The variation of the diffusion rate R$_{0}$ is reported in the box. Source: \cite{he2011mechanistic} }
 \label{SpanishFLU}
\end{figure}
...
\begin{figure}[h]
 ...
 \caption{Mortality range distribution for the two waves of Spanish flu: note that the second one was more severe for the young people. Source: \cite{taubenberger20061918}}
...
\begin{figure}[h]
 ...
 \caption{Wang-ShickRyu diagram for the explanantion of the Spanish, Asian flu and Honk-Kong flu . Source: \cite{RYU2017195}}
 \label{Mixing_Flu}
\end{figure}
